...
export const mockStacks: Stack[] = [
  {
    ...
    peptides: [
      { peptideId: 'bpc-157', doseMcg: 250, frequency: '2x daily', route: 'subq', timing: 'Morning and evening' },
      { peptideId: 'tb-500', doseMcg: 2500, frequency: '2x weekly', route: 'subq', timing: 'Monday and Thursday' }
    ],
  ...
  },
  {
    ...
    peptides: [
      { peptideId: 'ipamorelin', doseMcg: 200, frequency: 'daily', route: 'subq', timing: 'Pre-bed' },
      { peptideId: 'cjc-1295', doseMcg: 100, frequency: '2x weekly', route: 'subq', timing: 'With Ipamorelin on Mon/Thu' },
      { peptideId: 'epitalon', doseMcg: 5000, frequency: 'daily', route: 'subq', timing: '10-day cycle, then 4 months off' }
    ],
  ...
  },
  {
    ...
    peptides: [
      { peptideId: 'semaglutide', doseMcg: 500, frequency: 'weekly', route: 'subq', timing: 'Sunday morning' },
      { peptideId: 'mots-c', doseMcg: 5000, frequency: '2x weekly', route: 'subq', timing: 'Pre-workout days' }
    ],
